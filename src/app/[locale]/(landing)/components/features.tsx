            ...
            >
              <div className="hover:border-white/40 relative h-full overflow-hidden rounded-3xl border border-white/20 bg-white/10 p-8 backdrop-blur-sm transition-all duration-150 hover:bg-white/20 hover:shadow-lg">
                ...
                <m.div
                  ...
                  className="from-white/20 to-white/20 group-hover:from-white/30 group-hover:to-white/30 bg-linear-to-br mb-6 inline-flex h-16 w-16 items-center justify-center rounded-2xl transition-all duration-150"
                >
                  <feature.icon className="text-white h-8 w-8" />
                </m.div>

                {/* Content */}
                <h3 className="group-hover:text-white mb-3 text-xl font-bold text-white transition-colors duration-150">
                  {t(`${feature.key}.title`)}
                </h3>
